...
--- stored procedure
drop procedure spGetCostumers

create procedure spGetCostumers
as begin
...
-- näitab tabelisusu, kui kasutaja sisestab gender(sugu) ja departmentID
...
exec spGetEmployeesByGenderAndDepartment 'Male'
